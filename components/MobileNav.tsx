...
export function MobileNav() {
    ...
    return (
        <div className="md:hidden">
            ...
            {/* Sidebar Panel */}
            <div className={cn(
                "fixed inset-y-0 left-0 z-[101] w-72 bg-white dark:bg-zinc-950 border-r border-zinc-200 dark:border-zinc-800 shadow-2xl transform transition-transform duration-300 ease-in-out",

...
description: Automatically synced from https://clawn.ch/skill
category: Reference
---
...
> [!NOTE]
> This page is automatically synced from [https://clawn.ch/skill](https://clawn.ch/skill).
...
Post a tweet (text, reply, quote, poll, media)

`clawnx_get_tweet`

Get a tweet by ID or URL

`clawnx_search_tweets`

Search recent tweets (X query syntax)
...
Post multi-tweet thread (up to 25)
...
`clawnx_bookmark_tweet`

Bookmark a tweet

`clawnx_get_bookmarks`
...
`clawnx_get_my_profile`

Get authenticated user profile

`clawnx_get_home_timeline`
...
`clawnx_get_quote_tweets`

Get quote tweets

`clawnx_get_liking_users`
...
Bearer Token (read-only endpoints)
...
*   X / Twitter: https://x.com/Clawnch\_Bot
